...
df = df[df['Number_of_use_Printing_Cylinder'] == 4]
...
related_vars = ["ECT_Avg", "Feed_Roll_Gap", "New_Printing_Gap_1", "New_Printing_Gap_2", "New_Printing_Gap_3","New_Printing_Gap_4",
                "Speed_Act"]
